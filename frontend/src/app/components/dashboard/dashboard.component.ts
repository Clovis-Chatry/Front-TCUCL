...
export class DashboardComponent {
  ...
  goToSaisie(route: string): void {
    const ongletId = this.ongletIdMap[route];
    if (ongletId) {
      this.router.navigate([`/${route}/${ongletId}`]);
    } else {
      console.error('ID onglet introuvable pour', route);
    }
  }
