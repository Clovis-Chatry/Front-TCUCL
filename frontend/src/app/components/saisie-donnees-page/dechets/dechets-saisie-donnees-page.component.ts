...
export class DechetSaisieDonneesPageComponent implements OnInit {
  ...
  traitementsDisponibles: Record<TYPE_DECHET, TRAITEMENT_DECHET[]> = {
    [TYPE_DECHET.ORDURES_MENAGERES]: Object.values(TRAITEMENT_DECHET) as TRAITEMENT_DECHET[],
    [TYPE_DECHET.CARTONS]: [TRAITEMENT_DECHET.RECYCLAGE, TRAITEMENT_DECHET.INCINERATION] as TRAITEMENT_DECHET[],
    [TYPE_DECHET.VERRE]: [TRAITEMENT_DECHET.INCINERATION, TRAITEMENT_DECHET.RECYCLAGE] as TRAITEMENT_DECHET[],
    [TYPE_DECHET.METAUX]: [TRAITEMENT_DECHET.RECYCLAGE, TRAITEMENT_DECHET.INCINERATION] as TRAITEMENT_DECHET[],
    [TYPE_DECHET.TEXTILE]: Object.values(TRAITEMENT_DECHET) as TRAITEMENT_DECHET[],
  };
